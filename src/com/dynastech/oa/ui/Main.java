...
public class Main extends BaseActivity {
	...
	private void initData() {
		...
		homeurl = user.getAddress() + URLS._HOME_URL;
...
//						intent.setData(Uri.parse("lync://"));
						intent.setData(Uri.parse("sip://zhangfei@dynastech.com"));
					...
					startActivity(new Intent(context, DocumentsListActivity.class));
