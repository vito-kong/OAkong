...
import com.dynastech.cdmetro.newui.adapter.AwesomePagerAdapter;
...
import com.dynastech.cdmetro.newui.tasks.LoginTask;
...
import com.dynastech.cdmetro.utils.Constants;
...
public class Login extends BaseActivity implements OnClickListener,
	...
	private void loginMethod(View v) {
		...
		String url = ipaddress + Constant._LOGIN_URL;
		host = ipaddress.substring(7, ipaddress.length() - 5);
		port = Integer.parseInt(ipaddress.substring(ipaddress.length() - 4,
				ipaddress.length()));
		Log.i("==========", host + "---" + port);
