...
import com.dynastech.oa.email.MailSenderInfo;
import com.dynastech.oa.email.SimpleMailSender;
...
//							.execute("cdmetro-错误报告",crashReport);
	...
	public static void sendErrorMessage(Context ctx,String message,String email_title,String email_content){
		...
		mailInfo.setUserName(Constant.email_from_address); // 邮箱地址
		mailInfo.setPassword(Constant.email_from_pwd);// 邮箱密码
